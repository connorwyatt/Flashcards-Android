...
class Relationships(relationships: Map<*, *>?) {
  ...
  private fun cloneRelationships(
    relationships: MutableMap<String, MutableList<String>>): MutableMap<String, MutableList<String>> {
  ...
  private fun parseRawRelationships(
    rawRelationships: Map<*, *>): MutableMap<String, MutableList<String>> {
