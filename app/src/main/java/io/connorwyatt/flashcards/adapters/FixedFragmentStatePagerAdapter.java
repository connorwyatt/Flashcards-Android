...
public abstract class FixedFragmentStatePagerAdapter extends PagerAdapter {
    private static final String TAG = "FixedFragmentStatePagerAdapter";
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        String fragmentTag = getFragmentTag(position);
    ...
    public void destroyItem(ViewGroup container, int position, Object object) {
        ...
        if (DEBUG) Log.v(TAG.substring(0, 22), "Removing item #" + position + ": f=" + object
            ...
            for (String key : keys) {
                if (key.startsWith("f")) {
                    ...
                    if (f != null) {
                        ...
                        Log.w(TAG.substring(0, 22), "Bad fragment at key " + key);
                    }
                }
            }
        }
