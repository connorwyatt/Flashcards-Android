...
class CategoryViewHolder constructor(itemView: View) : RecyclerView.ViewHolder(itemView) {
  ...
  private val title: TextView = itemView.findViewById(
    R.id.fragment_category_list_item_category_title) as TextView
  private val count: TextView = itemView.findViewById(
    R.id.fragment_category_list_item_category_flashcard_count) as TextView
  private val status: TextView = itemView.findViewById(
    R.id.fragment_category_list_item_category_status) as TextView
  private val statusBar: LinearLayout = itemView.findViewById(
    R.id.fragment_category_list_item_category_status_bar) as LinearLayout
  private val menuButton: ImageButton = itemView.findViewById(
    R.id.fragment_category_list_item_category_menu) as ImageButton
